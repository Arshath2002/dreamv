<!--
 * @Description: 矩形树图映射字段
 * @Author: shenah
 * @Date: 2024-05-06 09:48:20
 * @LastEditors: shenah
 * @LastEditTime: 2024-05-11 16:13:47
-->
  ...
  <div class="des-dv-chart-edit-container">
    ...
    <div class="right">
      <el-scrollbar class="right-scroller">
        <div class="map-relation__item no-border-bottom no-margin" v-for="(item, index) in chartOptions.series" :key="`s_${index}`">
          <div class="map-relation__item-input map-relation__item_column">
            ...
            <div class="cell-item">
              ...
              <SelectInput v-model="item.valueRelation" :mapFieldList="mapFieldList" :defaultValue="true" />
            </div>
          </div>
        </div>
      </el-scrollbar>
